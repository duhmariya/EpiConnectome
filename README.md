...
→ See `results/GATv2_Results_v4/permutation_alpha.png` and `heatmap_alpha.png`
...
→ See `results/GATv2_Results_v4/subject_severity_heatmap.png`
...
→ See `results/GATv2_Results_v4/brain_topo_alpha/beta/theta.png`
...
→ See `results/GATv2_Results_v4/gatv2_vs_svm.png`
